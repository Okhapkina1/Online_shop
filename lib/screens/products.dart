...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void initState() {
    ...
    models.add(new ProductModel("Носки", "Немножко дырявые", "5 руб"));
    models.add(new ProductModel("Футболка", "Потеряла цвет", "200 руб"));
    models.add(new ProductModel("Куртка", "Крутая и модная", "1000 руб"));
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index){
            return ListTile(
              ...
              trailing: Text(models[index].prise),
              onTap: () {
